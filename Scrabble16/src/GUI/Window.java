...
public class Window extends JPanel {
    ...
    public Window() {
        ...
        message.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String input = JOptionPane.showInputDialog(Window.this, "Enter the letter of the tile you want to replace:");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (permanentPlacedTiles.isEmpty()) {
                    ...
                    if (!tilePlacedAtCenter) {
                        JOptionPane.showMessageDialog(Window.this, "The first word must have a tile placed in row 7 and column 7");
                        return;
                    }
                    ...
                    if (!scrabbleDictionary.isWordInDictionary(placedWord)) {
                        JOptionPane.showMessageDialog(Window.this, "The word " + placedWord + " is not in the dictionary");
                        return;
                    }
                }
    ...
    private void displayTheScore() {
        JOptionPane.showMessageDialog(Window.this, "Game has ended");
        ...
        JOptionPane.showMessageDialog(Window.this, finalScores);
    }
        ...
        if (tile == '*') {
            ...
            theTile.getLabel().addMouseListener(new MouseAdapter() {
                public void mousePressed(MouseEvent e) {
                    String input = JOptionPane.showInputDialog(Window.this, "Enter a letter");
                    if (input != null && input.length() == 1) {
                        char letter = input.charAt(0);
                        if (letter >= 'A' && letter <= 'Z') {
...
//                Tile newTile = new Tile(tile, row, col);
    ...
    private void switchToNextPlayer() {
        ...
        // Add a popup screen to inform the next player that it's their turn
