...
public class Tileimage {
    ...
    private static final String TILE_IMAGE_PATH = "/Users/damianshoker/Downloads/Scrabllee_thumbnail.png";
    ...
    static {
        ...
        for (int y = 0; y < 376; y += 94) {
            for (int x = 0; x < 658; x += 94) {
            	char letter;
                if (ind <= 25) {
                    letter = (char) (ind + 'A');
                } else {
                ...
                Image img = all.getSubimage(x, y, 94, 94).getScaledInstance(40, 40, BufferedImage.SCALE_SMOOTH);
